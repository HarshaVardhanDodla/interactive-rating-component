...
function App() {
  ...
  return (
    <>
      ...
      {isSubmitted && <ThankYou item={item} setIsSubmitted={setIsSubmitted} />}
    </>
  );
}

const ThankYou = ({ item, setIsSubmitted }) => {
  return (
    <div className="wrapper">
      <img className="block" src={thank} alt="" />
      <div className="flex item-center justify-center">
        <p className="p-rating bg-gray-700 rounded-full text-center text-sm px-4 pt-1">
          You selected {item} out of 5
        </p>
      </div>
